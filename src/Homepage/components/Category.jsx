...
function Category(props) {
    ...
    return (
        <div className={`z-auto transition duration-500 ease-in-out hover:shadow-xl h-44 w-60 transform hover:translate-y-6  bg-red-300  hover:bg-catHover-pattern rounded-lg flex items-center justify-center`}>
